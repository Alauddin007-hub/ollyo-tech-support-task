	...
	<div class="panel-body">
		<form method="post" id="edit_profile_form">
			...
			<div class="form-group">
				...
				<input type="password" name="user_old_password" id="user_old_password" class="form-control" required />
			</div>
			<div class="form-group">
		...
		$('#edit_profile_form').on('submit', function(event) {
			...
			if ($('#user_old_password').val() != '') {
				...
				if ($('#user_new_password').val() != '') {
					...
					$('#error_password').html('<label class="text-danger">Place fill user new password</label>');
				}
			}
